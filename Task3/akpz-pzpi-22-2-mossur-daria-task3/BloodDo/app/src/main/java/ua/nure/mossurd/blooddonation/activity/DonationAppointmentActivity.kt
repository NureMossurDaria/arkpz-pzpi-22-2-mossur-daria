...
class DonationAppointmentActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        LocaleService.initLocale(this@DonationAppointmentActivity, applicationContext)
        super.onCreate(savedInstanceState)

        val token = this@DonationAppointmentActivity.getSharedPreferences(
        ...
        val language = Optional.ofNullable(
            this@DonationAppointmentActivity.getSharedPreferences(
                Constants.BLOODDO_CONTEXT_PREFS,
                MODE_PRIVATE
            )
        ...
        Constants.API_SERVICE.getAvailableEvents(token)
            .enqueue(object : Callback<List<DonationEventDto>> {
                ...
                override fun onFailure(
                    ...
                    Log.e(
                        this.javaClass.name,
                        "Get available events request failure. Message: ${t.message}"
                    )
                    afterRequest()
                }
                        ...
                        Scaffold(
                            ...
                            topBar = {
                                Text(
                                    ...
                                    text = getString(R.string.donation_appointment_header)
                                )
                            },
                            bottomBar = {
                                Button(
                                    modifier = Modifier
                                        ...
                                        .height(60.dp),
                                    onClick = {
                                        this@DonationAppointmentActivity.finish()
                                    }
                                ) {
                                    ...
                                    Row(
                                        modifier = Modifier
                                            ...
                                            .pointerInput(Unit) {
                                                detectTapGestures(
                                                    onTap = {
                                                        AlertDialog.Builder(this@DonationAppointmentActivity)
                                                            .setTitle(R.string.donation_appointment_confirm_appointment)
                                                            .setMessage(eventText)
                                                            .setPositiveButton(R.string.generic_ok_button) { dialog, which ->
                                                                Constants.API_SERVICE.createEventAppointment(
                                                                    token,
                                                                    eventInfo.id
                                                                    ...
                                                                    override fun onResponse(
                                                                        ...
                                                                        if (response.isSuccessful) {
                                                                            Toast.makeText(
                                                                                applicationContext,
                                                                                getString(R.string.donation_appointment_confirm_appointment_done),
                                                                                Toast.LENGTH_SHORT
                                                                            ).show()
                                                                    ...
                                                                    override fun onFailure(
                                                                        ...
                                                                        Log.e(
                                                                            this.javaClass.name,
                                                                            "Create appointment request failure. Message: ${t.message}"
                                                                        )
                                                                    }
